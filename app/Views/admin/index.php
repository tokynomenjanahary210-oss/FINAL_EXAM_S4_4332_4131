...
<div class="sidebar">
    ...
    <ul class="sidebar-nav">
        <li><a href="/admin" class="active"><i class="bi bi-speedometer2 me-2"></i>Tableau de bord</a></li>
        <li><a href="/admin/prefixes"><i class="bi bi-telephone me-2"></i>Préfixes</a></li>
        <li><a href="/admin/operation_types"><i class="bi bi-arrow-repeat me-2"></i>Types d'opérations</a></li>
        <li><a href="/admin/fee_brackets"><i class="bi bi-calculator me-2"></i>Barèmes de frais</a></li>
        ...
        <li><a href="/admin/other_operators"><i class="bi bi-building me-2"></i>Autres opérateurs</a></li>
        <li><a href="/admin/commission"><i class="bi bi-percent me-2"></i>Commission</a></li>
        <li><a href="/admin/amounts_to_send"><i class="bi bi-cash-stack me-2"></i>Montants à reverser</a></li>
