...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <div class="navbar-nav">
            <a class="nav-link active" href="/admin">Tableau de bord</a>
        ...
        <div class="col-md-4">
            <div class="card text-white bg-primary shadow border-0">
                <div class="card-body">
                    ...
                    <p class="card-text display-4 fw-bold"><?= $clients_count ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
                ...
                <table class="table table-striped table-hover table-bordered mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold text-success"><?= number_format($client['balance']) ?> Ar</td>
