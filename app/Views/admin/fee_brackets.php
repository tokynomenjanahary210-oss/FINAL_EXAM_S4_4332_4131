                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/admin/fee_brackets/edit/<?= $bracket['id'] ?>" class="btn btn-outline-custom btn-sm">Modifier</a>
                                <a href="/admin/fee_brackets/delete/<?= $bracket['id'] ?>" class="btn btn-outline-custom btn-sm" style="border-color: var(--danger); color: var(--danger);" onclick="return confirm('Supprimer ce barème ?')">Supprimer</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
